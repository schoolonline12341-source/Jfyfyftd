...
Gui.Parent          = (syn and syn.protect_gui and syn.protect_gui(Gui)) and Gui
    or (pcall(function() Gui.Parent = game:GetService("CoreGui") end) and Gui)
    or (Gui.Parent = game:GetService("CoreGui"), Gui)
